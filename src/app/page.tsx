      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-primary">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <AnimatedSection>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-heading text-white leading-tight max-w-4xl">
              We turn{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold font-heading text-foreground">What our clients say</h2>
            </div>
          </AnimatedSection>
